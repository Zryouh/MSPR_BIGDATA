...
/**
 * Job: MonJob Purpose: trest<br>
 * Description: test <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class MonJob implements TalendJob {
	...
	private final String jobName = "MonJob";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(MonJob.this, new Object[] { e,
	...
	public static void main(String[] args) {
		final MonJob MonJobClass = new MonJob();

		int exitCode = MonJobClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = MonJob.class.getClassLoader()
					.getResourceAsStream(
							"mspr/monjob_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
				inContext = MonJob.class.getClassLoader().getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : MonJob");
		}
...
/************************************************************************************************
 * 24061 characters generated by Talend Open Studio for Data Integration on the
 * 12 juin 2022 23:31:34 CEST
 ************************************************************************************************/
