	...
	public void tMsgBox_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String titletMsgBox_1 = "Test";
				String messagetMsgBox_1 = "Welcome to Git";
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = TestGit.class.getClassLoader()
					.getResourceAsStream(
							"mspr/testgit_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 24054 characters generated by Talend Open Studio for Data Integration on the
 * 12 juin 2022 13:01:19 CEST
 ************************************************************************************************/
